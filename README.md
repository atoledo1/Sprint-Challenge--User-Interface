...
Semantic HTML is HTML that goes beyond just affecting the presentation but also gives meaning. 
...
It allows developers to be able to work on something at the same time while keeping clear track of the changes and the different versions of it. 

5. Define mobile-first design in your own words.
 It is a way of designing that first starts with taking the smallest screen into consideration and then continuing to other bigger screen sizes. 
